...
class ProductsView extends View
{
	...
	function fetch()
	{
		...
		if(!empty($category))
		{
			...
			$this->design->assign('min_price', $this->products->getMinPrice($category->children));
			$this->design->assign('max_price', $this->products->getMaxPrice($category->children));

			$this->design->assign('features', $features);
 		}

 		if(!empty($brand)){
 			$this->design->assign('min_price', $this->products->getMinPriceBrand($brand->id));
			$this->design->assign('max_price', $this->products->getMaxPriceBrand($brand->id));
 		}
