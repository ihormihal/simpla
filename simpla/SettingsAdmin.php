...
{	
	...
	{	
 		...
 		if($this->request->method('POST'))
		{
			...
			$this->settings->default_delivery = $this->request->post('default_delivery');
			$this->settings->default_payment = $this->request->post('default_payment');

			$this->settings->cart_discount = $this->request->post('cart_discount');
