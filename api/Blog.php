...
class Blog extends Simpla
{
	...
	*/
	public function get_post($id)
	{
		...
		$query = $this->db->placehold("SELECT b.id, b.category, b.url, b.name, b.image, b.annotation, b.text, b.meta_title,
	...
	*/
	...
	{	
		...
		if(!empty($filter['category']))
			///$post_category_filter = $this->db->placehold('AND b.category = ?', (int)$filter['category']);
		...
		$query = $this->db->placehold("SELECT b.id, b.category, b.url, b.name, b.image, b.annotation, b.text,
