$(function() {
	...
	$('.tooltip').on('mouseleave', function(){tooltipcanclose=true;setTimeout("close_tooltip();", 300);});
	$('.tooltip').on('mouseover', function(){tooltipcanclose=false;});
...
function show_tooltip()
{
	...
	tooltip.css('top',  $(this).height() + $(this).offset().top + 'px');
	tooltip.css('left', ($(this).offset().left + $(this).outerWidth()*0.5 - (flip ? tooltip.width()-40 : 40)  + 0) + 'px');
